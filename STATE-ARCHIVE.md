# STATE ARCHIVE - Client Dashboard

Everything below is the full session history up to 2026-08-17, moved out of
STATE.md on her order so that file could become short and true again.
NOTHING HAS BEEN DELETED. This is the complete record, in the same order it
was written. STATE.md carries only what is currently true; when you need to
know why something is the way it is, the reason is in here.

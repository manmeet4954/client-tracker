...
// Results window renders here, because a client reaches this address through
...
import { ResultsWindow } from '@/components/shell/ClientWindows';
...
export default function AnalysisLanding({ params }: { params: { id: string } }) {
  ...
  if (kind !== 'owner') return <ResultsWindow profileId={params.id} />;
  return null;
}
